...
public class MazeGame {
        ...
        try (Scanner input = new Scanner(System.in)) {
            ...
            for (intentosRestantes = 20; intentosRestantes > 0; intentosRestantes--) {
                ...
                if (respuestaMovimiento.equalsIgnoreCase("i")) {
                    ...
                    if (matriz[x][y] == '#') {
                        System.out.println("No se puede lanzar una bomba aquí por que está bloqueado");
                    } else {
                    for (int i = 0; i < monstruos.length; i++) {
                        if (monstruos[i] != null) {
                            if (monstruos[i].getFila() == x && monstruos[i].getColumna() == y) {
                ...
                if (monstruos[3] == null) {
                    if (Movimiento1 && monstruos[1] == null && monstruos[2] == null) {
                        System.out.println("No se puede mover mas, has ganado!");
                        break;
                    }
                    if (monstruos[0] == null && Movimiento2 && monstruos[2] == null) {
                        System.out.println("No se puede mover mas, has ganado!");
                        break;
                    }
                    if (monstruos[0] == null && monstruos[1] == null && Movimiento3) {
                        System.out.println("No se puede mover mas, has ganado!");
                        break;
                    }
                    if (Movimiento1 && Movimiento2 && monstruos[2] == null) {
                        System.out.println("No se pueden mover mas, has ganado!");
                        break;
                    }
                    if (monstruos[0] == null && Movimiento2 && Movimiento3) {
                        System.out.println("No se pueden mover mas, has ganado!");
                        break;
                    }
                    if (Movimiento1 && monstruos[1] == null && Movimiento3) {
                        System.out.println("No se pueden mover mas, has ganado!");
                        break;
                    }
    ...
    public static void MovimientoMountruos(Monstruo monstruos[], char matriz[][]) {
        ...
        if (monstruos[0] != null) {
            switch (Random1) {
            //Movimiento monstruo Trebol.

            case 0:
                if (monstruos[0].getFila() - 1 >= 0 && matriz[monstruos[0].getFila() - 1][monstruos[0].getColumna()] == ' ' && matriz[monstruos[0].getFila() - 1][monstruos[0].getColumna()] != '#') {
                    matriz[monstruos[0].getFila()][monstruos[0].getColumna()] = ' ';
            ...
            case 1:
                if (monstruos[0].getFila() + 1 < matriz.length && matriz[monstruos[0].getFila() + 1][monstruos[0].getColumna()] == ' ' && matriz[monstruos[0].getFila() + 1][monstruos[0].getColumna()] != '#') {
                    matriz[monstruos[0].getFila()][monstruos[0].getColumna()] = ' ';
                    monstruos[0].setFila(monstruos[0].getFila() + 1);
                    matriz[monstruos[0].getFila()][monstruos[0].getColumna()] = monstruos[0].getSimbolo();
                }
                break;
            case 2:
                if (monstruos[0].getColumna() - 1 >= 0 && matriz[monstruos[0].getFila()][monstruos[0].getColumna() - 1] == ' ' && matriz[monstruos[0].getFila()][monstruos[0].getColumna() - 1] != '#') {
                    matriz[monstruos[0].getFila()][monstruos[0].getColumna()] = ' ';
                ...
                break;
            case 3:
                if (monstruos[0].getColumna() + 1 < matriz.length && matriz[monstruos[0].getFila()][monstruos[0].getColumna() + 1] == ' ' && matriz[monstruos[0].getFila()][monstruos[0].getColumna() + 1] != '#') {
                    matriz[monstruos[0].getFila()][monstruos[0].getColumna()] = ' ';
                    monstruos[0].setColumna(monstruos[0].getColumna() + 1);
                    matriz[monstruos[0].getFila()][monstruos[0].getColumna()] = monstruos[0].getSimbolo();
                }
    ...
    if (monstruos[1] != null) {
        switch (Random2) {
        //Movimiento monstruo Diamante.

            case 0:
                if (monstruos[1].getFila() - 1 >= 0 && matriz[monstruos[1].getFila() - 1][monstruos[1].getColumna()] == ' ' && matriz[monstruos[1].getFila() - 1][monstruos[1].getColumna()] != '#') {
                    matriz[monstruos[1].getFila()][monstruos[1].getColumna()] = ' ';
            ...
            case 1:
                if (monstruos[1].getFila() + 1 < matriz.length && matriz[monstruos[1].getFila() + 1][monstruos[1].getColumna()] == ' ' && matriz[monstruos[1].getFila() + 1][monstruos[1].getColumna()] != '#') {
                    matriz[monstruos[1].getFila()][monstruos[1].getColumna()] = ' ';
                    monstruos[1].setFila(monstruos[1].getFila() + 1);
                    matriz[monstruos[1].getFila()][monstruos[1].getColumna()] = monstruos[1].getSimbolo();
                }
                break;
            case 2:
                if (monstruos[1].getColumna() - 1 >= 0 && matriz[monstruos[1].getFila()][monstruos[1].getColumna() - 1] == ' ' && matriz[monstruos[1].getFila()][monstruos[1].getColumna() - 1] != '#') {
                    matriz[monstruos[1].getFila()][monstruos[1].getColumna()] = ' ';
                ...
                break;
            case 3:
                if (monstruos[1].getColumna() + 1 < matriz.length && matriz[monstruos[1].getFila()][monstruos[1].getColumna() + 1] == ' ' && matriz[monstruos[1].getFila()][monstruos[1].getColumna() + 1] != '#') {
                    matriz[monstruos[1].getFila()][monstruos[1].getColumna()] = ' ';
                    monstruos[1].setColumna(monstruos[1].getColumna() + 1);
                    matriz[monstruos[1].getFila()][monstruos[1].getColumna()] = monstruos[1].getSimbolo();
                }
            ...
            case 4:
                if (monstruos[1].getFila() + 1 < matriz.length && monstruos[1].getColumna() + 1 < matriz.length && matriz[monstruos[1].getFila() + 1][monstruos[1].getColumna() + 1] == ' ' && matriz[monstruos[1].getFila() + 1][monstruos[1].getColumna() + 1] != '#') {
                    matriz[monstruos[1].getFila()][monstruos[1].getColumna()] = ' ';
                    monstruos[1].setColumna(monstruos[1].getColumna() + 1);
                    monstruos[1].setFila(monstruos[1].getFila() + 1);
                    matriz[monstruos[1].getFila()][monstruos[1].getColumna()] = monstruos[1].getSimbolo();
                ...
                break;
            case 5:
                if (monstruos[1].getFila() - 1 >= 0 && monstruos[1].getColumna() - 1 >= 0 && matriz[monstruos[1].getFila() - 1][monstruos[1].getColumna() - 1] == ' ' && matriz[monstruos[1].getFila() - 1][monstruos[1].getColumna() - 1] != '#') {
                    matriz[monstruos[1].getFila()][monstruos[1].getColumna()] = ' ';
                    monstruos[1].setColumna(monstruos[1].getColumna() - 1);
                    monstruos[1].setFila(monstruos[1].getFila() - 1);
                    matriz[monstruos[1].getFila()][monstruos[1].getColumna()] = monstruos[1].getSimbolo();
                ...
                break;
            case 6:
                if (monstruos[1].getFila() + 1 < matriz.length && monstruos[1].getColumna() - 1 >= 0 && matriz[monstruos[1].getFila() + 1][monstruos[1].getColumna() - 1] == ' ' && matriz[monstruos[1].getFila() + 1][monstruos[1].getColumna() - 1] != '#') {
                    matriz[monstruos[1].getFila()][monstruos[1].getColumna()] = ' ';
                    monstruos[1].setColumna(monstruos[1].getColumna() - 1);
                    monstruos[1].setFila(monstruos[1].getFila() + 1);
                    matriz[monstruos[1].getFila()][monstruos[1].getColumna()] = monstruos[1].getSimbolo();
                ...
                break;
            case 7:
                if (monstruos[1].getFila() - 1 >= 0 && monstruos[1].getColumna() + 1 < matriz.length && matriz[monstruos[1].getFila() - 1][monstruos[1].getColumna() + 1] == ' ' && matriz[monstruos[1].getFila() - 1][monstruos[1].getColumna() + 1] != '#') {
                    matriz[monstruos[1].getFila()][monstruos[1].getColumna()] = ' ';
                    monstruos[1].setColumna(monstruos[1].getColumna() + 1);
                    monstruos[1].setFila(monstruos[1].getFila() - 1);
                    matriz[monstruos[1].getFila()][monstruos[1].getColumna()] = monstruos[1].getSimbolo();
    ...
    if (monstruos[2] != null) {
        switch (Random3) {
        //Movimiento monstruo Pica

            case 0:
                if (monstruos[2].getFila() + 2 < matriz.length && monstruos[2].getColumna() + 2 < matriz.length && matriz[monstruos[2].getFila() + 2][monstruos[2].getColumna() + 2] == ' ' && matriz[monstruos[2].getFila() + 2][monstruos[2].getColumna() + 2] != '#') {
                    matriz[monstruos[2].getFila()][monstruos[2].getColumna()] = ' ';
                ...
                break;
            case 1:
                if (monstruos[2].getFila() - 2 >= 0 && monstruos[2].getColumna() - 2 >= 0 && matriz[monstruos[2].getFila() - 2][monstruos[2].getColumna() - 2] == ' ' && matriz[monstruos[2].getFila() - 2][monstruos[2].getColumna() - 2] != '#') {
                    matriz[monstruos[2].getFila()][monstruos[2].getColumna()] = ' ';
                    monstruos[2].setColumna(monstruos[2].getColumna() - 2);
                    monstruos[2].setFila(monstruos[2].getFila() - 2);
                    matriz[monstruos[2].getFila()][monstruos[2].getColumna()] = monstruos[2].getSimbolo();
                ...
                break;
            case 2:
                if (monstruos[2].getFila() + 2 < matriz.length && monstruos[2].getColumna() - 2 >= 0 && matriz[monstruos[2].getFila() + 2][monstruos[2].getColumna() - 2] == ' ' && matriz[monstruos[2].getFila() + 2][monstruos[2].getColumna() - 2] != '#') {
                    matriz[monstruos[2].getFila()][monstruos[2].getColumna()] = ' ';
                    monstruos[2].setColumna(monstruos[2].getColumna() - 2);
                    monstruos[2].setFila(monstruos[2].getFila() + 2);
                    matriz[monstruos[2].getFila()][monstruos[2].getColumna()] = monstruos[2].getSimbolo();
                ...
                break;
            case 3:
                if (monstruos[2].getFila() - 2 >= 0 && monstruos[2].getColumna() + 2 < matriz.length && matriz[monstruos[2].getFila() - 2][monstruos[2].getColumna() + 2] == ' ' && matriz[monstruos[2].getFila() - 2][monstruos[2].getColumna() + 2] != '#') {
                    matriz[monstruos[2].getFila()][monstruos[2].getColumna()] = ' ';
                    monstruos[2].setColumna(monstruos[2].getColumna() + 2);
                    monstruos[2].setFila(monstruos[2].getFila() - 2);
                    matriz[monstruos[2].getFila()][monstruos[2].getColumna()] = monstruos[2].getSimbolo();
            ...
            if (monstruos[3] != null) {
                switch (Random4) {
                //Movimiento monstruo Corazon

                    case 0:
                        if (monstruos[3].getFila() + 1 < matriz.length && monstruos[3].getColumna() + 1 < matriz.length && matriz[monstruos[3].getFila() + 1][monstruos[3].getColumna() + 1] != '\u2663' && matriz[monstruos[3].getFila() + 1][monstruos[3].getColumna() + 1] != '\u2666' && matriz[monstruos[3].getFila() + 1][monstruos[3].getColumna() + 1] != '\u2660') {
                            matriz[monstruos[3].getFila()][monstruos[3].getColumna()] = ' ';
                        ...
                        break;
                    case 1:
                        if (monstruos[3].getFila() - 1 >= 0 && monstruos[3].getColumna() - 1 >= 0 && matriz[monstruos[3].getFila() - 1][monstruos[3].getColumna() - 1] != '\u2663' && matriz[monstruos[3].getFila() - 1][monstruos[3].getColumna() - 1] != '\u2666' && matriz[monstruos[3].getFila() - 1][monstruos[3].getColumna() - 1] != '\u2660') {
                            matriz[monstruos[3].getFila()][monstruos[3].getColumna()] = ' ';
                            monstruos[3].setColumna(monstruos[3].getColumna() - 1);
                            monstruos[3].setFila(monstruos[3].getFila() - 1);
                            matriz[monstruos[3].getFila()][monstruos[3].getColumna()] = monstruos[3].getSimbolo();
                        ...
                        break;
                    case 2:
                        if (monstruos[3].getFila() + 1 < matriz.length && monstruos[3].getColumna() - 1 >= 0 && matriz[monstruos[3].getFila() + 1][monstruos[3].getColumna() - 1] != '\u2663' && matriz[monstruos[3].getFila() + 1][monstruos[3].getColumna() - 1] != '\u2666' && matriz[monstruos[3].getFila() + 1][monstruos[3].getColumna() - 1] != '\u2660') {
                            matriz[monstruos[3].getFila()][monstruos[3].getColumna()] = ' ';
                            monstruos[3].setColumna(monstruos[3].getColumna() - 1);
                            monstruos[3].setFila(monstruos[3].getFila() + 1);
                            matriz[monstruos[3].getFila()][monstruos[3].getColumna()] = monstruos[3].getSimbolo();
                        ...
                        break;
                    case 3:
                        if (monstruos[3].getFila() - 1 >= 0 && monstruos[3].getColumna() + 1 < matriz.length && matriz[monstruos[3].getFila() - 1][monstruos[3].getColumna() + 1] != '\u2663' && matriz[monstruos[3].getFila() - 1][monstruos[3].getColumna() + 1] != '\u2666' && matriz[monstruos[3].getFila() - 1][monstruos[3].getColumna() + 1] != '\u2660') {
                            matriz[monstruos[3].getFila()][monstruos[3].getColumna()] = ' ';
                            monstruos[3].setColumna(monstruos[3].getColumna() + 1);
                            monstruos[3].setFila(monstruos[3].getFila() - 1);
                            matriz[monstruos[3].getFila()][monstruos[3].getColumna()] = monstruos[3].getSimbolo();
